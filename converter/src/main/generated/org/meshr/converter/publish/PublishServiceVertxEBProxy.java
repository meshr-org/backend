...
public class PublishServiceVertxEBProxy implements PublishService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public PublishServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public PublishServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
