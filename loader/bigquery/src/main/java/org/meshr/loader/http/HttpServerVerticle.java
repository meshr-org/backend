...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> promise) throws Exception {
        ...
        String bigqueryQueue = config().getString(CONFIG_BIGQUERY_QUEUE, "bigquery.queue");
        bigQueryService = BigQueryService.createProxy(vertx, bigqueryQueue);
    ...
    private void apiReceiver(RoutingContext context) {
        ...
        bigQueryService.insertData(body, topic, handler);
    }
}