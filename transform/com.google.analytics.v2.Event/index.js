...
function transform(request){
    ...
    if (data.payload) {
        data.payload.split("\n").forEach(function(e) {
            //var tmp = Object.assign(queryStringParser(data.queryString), queryStringParser(e));
            payloads.push(Object.assign(queryStringParser.parse(data.queryString), queryStringParser.parse(e)));
        });
    } else {
        payloads.push(queryStringParser.parse(data.queryString));
    }
    ...
    payloads.forEach(function(payload) {
        var message = {};
        message.attributes = typeof attributes  !== 'undefined' ?  attributes  : {};
        message.data = {
            version : payload.v,
